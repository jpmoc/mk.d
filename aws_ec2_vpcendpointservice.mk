...
_ec2_view_framework_targets ::
	...
	@echo '    _ec2_view_vpcendpointservices                      - View VPC-endpoint-services'
	@echo '    _ec2_view_vpcendpointservices_set                  - View set of VPC-endpoint-services'
	@echo 
...
_ec2_show_vpcendpointservice: _ec2_show_vpcendpointservice_description
...
_ec2_show_vpcendpointservice_description:
	...
	$(AWS) ec2 describe-vpc-endpoint-services $(__EC2_FILTER__VPCENDPOINTSERVICE) --query "ServiceDetails[$(EC2_UI_SHOW_VPCENDPOINTSERVICE_QUERYFILTER)]"

_ec2_view_vpcendpointservices:
	@$(INFO) '$(EC2_UI_LABEL)View vpc-endpoint-services ...'; $(NORMAL)
	$(AWS) ec2 describe-vpc-endpoint-services $(_X__EC2_FILTER__VPCENDPOINTSERVICES) $(__EC2_SERVICE_NAMES__VPCENDPOINTSERVICES) --query "ServiceNames[]$((EC2_UI_VIEW_VPCENDPOINTSERVICES_FIELDS)"

_ec2_view_vpcendpointservices_set:
	@$(INFO) '$(EC2_UI_LABEL)View vpc-endpoint-services-set "$(EC2_VPCENDPOINTSERVICES_SET_NAME)" ...'; $(NORMAL)
	$(AWS) ec2 describe-vpc-endpoint-services $(__EC2_FILTER__VPCENDPOINTSERVICES) $(__EC2_SERVICE_NAMES__VPCENDPOINTSERVICES) --query "ServiceNames[$(_EC2_UI_VIEW_VPCENDPOINTSERVICES_SET_QUERYFILTER)]$(EC2_UI_VIEW_VPCENDPOINTSERVICES_SET_FIELDS)"
