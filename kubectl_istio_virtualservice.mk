...
# KCL_VIRTUALSERVICE_MANIFEST_DIRPATH?=
# KCL_VIRTUALSERVICE_MANIFEST_FILENAME?=
# KCL_VIRTUALSERVICE_MANIFEST_FILEPATH?=
...
KCL_VIRTUALSERVICE_MANIFEST_DIRPATH?= $(KCL_INPUTS_DIRPATH)
KCL_VIRTUALSERVICE_MANIFEST_FILEPATH?= $(KCL_VIRTUALSERVICE_MANIFEST_DIRPATH)$(KCL_VIRTUALSERVICE_MANIFEST_FILENAME)
...
# Option parameters
__KCL_FILENAME__VIRTUALSERVICE= $(if $(KCL_VIRTUALSERVICE_MANIFEST_FILEPATH),--filename $(KCL_VIRTUALSERVICE_MANIFEST_FILEPATH))
...
_kcl_view_framework_parameters ::
	...
	@echo '    KCL_VIRTUALSERVICE_MANIFEST_DIRPATH=$(KCL_VIRTUALSERVICE_MANIFEST_DIRPATH)'
	@echo '    KCL_VIRTUALSERVICE_MANIFEST_FILENAME=$(KCL_VIRTUALSERVICE_MANIFEST_FILENAME)'
	@echo '    KCL_VIRTUALSERVICE_MANIFEST_FILEPATH=$(KCL_VIRTUALSERVICE_MANIFEST_FILEPATH)'
...
_kcl_view_framework_targets ::
	...
	@echo '    _kcl_apply_virtualservice                   - Apply a virtual-service'
	...
	@echo '    _kcl_unapply_virtualservice                 - Unapply a manifest for a virtual-service'
...
_kcl_apply_virtualservice:
	@$(INFO) '$(KCL_UI_LABEL)Applying manifest for virtual-service "$(KCL_VIRTUALSERVICE_NAME)" ...'; $(NORMAL)
	cat $(KCL_VIRTUALSERVICE_MANIFEST_FILEPATH); echo
	$(KUBECTL) apply $(__KCL_FILENAME__VIRTUALSERVICE) $(__KCL_NAMESPACE__VIRTUALSERVICE)
...
_kcl_unapply_virtualservice:
	@$(INFO) '$(KCL_UI_LABEL)Un-applying manifest for virtual-service "$(KCL_VIRTUALSERVICE_NAME)" ...'; $(NORMAL)
	cat $(KCL_VIRTUALSERVICE_MANIFEST_FILEPATH)
	$(KUBECTL) delete $(__KCL_FILENAME__VIRTUALSERVICE) $(__KCL_NAMESPACE__VIRTUALSERVICE)
