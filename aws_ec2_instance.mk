...
# Customizations
_EC2_GET_INSTANCE_PARAMETERS_FIELDS?= .[InstanceId,Tags[?Key=='Name']|[0].Value,PublicIpAddress]
# _EC2_LIST_INSTANCES_FIELDS?=.{Name:Tags[?Key=='Name']|[0].Value,InstanceId:InstanceId,_InstanceType:InstanceType,_ImageId:ImageId,_AvailabilityZone:Placement.AvailabilityZone,_PrivateIp:PrivateIpAddress,_PublicIp:PublicIpAddress,State:State.Name,_VpcId:VpcId,_KeyName:KeyName}
_EC2_LIST_INSTANCES_FIELDS?= .{Name:Tags[?Key=='Name']|[0].Value,InstanceId:InstanceId,instanceType:InstanceType,imageId:ImageId,availabilityZone:Placement.AvailabilityZone,keyName:KeyName,publicIp:PublicIpAddress,state:State.Name}
_EC2_LIST_INSTANCES_SET_FIELDS?= $(_EC2_LIST_INSTANCES_FIELDS)
...
_ec2_get_instance_parameters_I= $(shell $(AWS) ec2 describe-instances --instance-ids $(1) --query "Reservations[].Instances[]$(_EC2_GET_INSTANCE_PARAMETERS_FIELDS)" --output text))
...
_ec2_list_targets ::
	...
	@echo '    _ec2_create_instance                    - Create an instance'
	@echo '    _ec2_delete_instance                    - Delete an instance'
	@echo '    _ec2_list_instances                     - List all instances'
	@echo '    _ec2_list_instances_set                 - List a set of instances'
...
_ec2_create_instance:
	@$(INFO) '$(EC2_UI_LABEL)Creating instance "$(EC2_INSTANCE_NAME)" ...'; $(NORMAL)
...
_ec2_list_instances:
	@$(INFO) '$(EC2_UI_LABEL)Listing ALL instances ...'; $(NORMAL)
	$(AWS) ec2 describe-instances $(_X__EC2_FILTERS__INSTANCES) --query "Reservations[].Instances[]$(_EC2_LIST_INSTANCES_FIELDS)"

_ec2_list_instances_set:
	@$(INFO) '$(EC2_UI_LABEL)Listing instances-set "$(EC2_INSTANCES_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'Instances are grouped based on provided filter'; $(NORMAL)
	$(AWS) ec2 describe-instances $(__EC2_FILTERS__INSTANCES) --query "Reservations[].Instances[]$(_EC2_LIST_INSTANCES_SET_FIELDS)"

_ec2_protect_instance:
	@$(INFO) '$(EC2_UI_LABEL)Applying termination-protection to instance "$(EC2_INSTANCE_NAME)" ...'; $(NORMAL)

_EC2_SHOW_INSTANCE_TARGETS?= _ec2_show_instance_securitygroups _ec2_show_instance_userdata _ec2_show_instance_description
# _EC2_SHOW_INSTANCE_TARGETS?= _ec2_show_instance_attributes _ec2_show_instance_securitygroups _ec2_show_instance_userdata _ec2_show_instance_description
_ec2_show_instance: $(_EC2_SHOW_INSTANCE_TARGETS)
...
_ec2_show_instance_tags:
	...
	$(AWS) ec2 describe-instances $(__EC2_INSTANCE_IDS__INSTANCE) --query "Reservations[].Instances[]$(_EC2_SHOW_INSTANCE_TAGS_FIELDS)"
