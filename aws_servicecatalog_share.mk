...
_scg_list_targets ::
	...
	@echo '    _scg_list_imported_portfolios               - List portfolios shared with this account'
...
_scg_list_imported_portfolios:
	@$(INFO) '$(SCG_UI_LABEL)Listing portfolios which are shared with this account ...'; $(NORMAL)
