...
_view_framework_macros :: _dkr_view_framework_macros
_dkr_view_framework_macros ::
	@echo 'Docker ($(_DOCKER_MK_VERSION)) macros:'
	@echo

_view_framework_parameters :: _dkr_view_framework_parameters
...
_view_framework_targets :: _dkr_view_framework_targets
...
_install_framework_dependencies :: _dkr_install_dependencies
