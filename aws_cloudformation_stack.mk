...
_CFN_SHOW_STACK_EVENTS_QUERYFILTER?= $(CFN_STACK_LAYER_QUERYFILTER)
_CFN_SHOW_STACK_EVENTS_FIELDS?= $(_CFN_SHOW_LAYER_EVENTS_FIELDS)
_CFN_SHOW_STACK_OUTPUTS_FIELDS?= $(_CFN_SHOW_LAYER_OUTPUTS_FIELDS)
_CFN_SHOW_STACK_REASONS_FIELDS?= $(_CFN_SHOW_LAYER_REASONS_FIELDS)
_CFN_SHOW_STACK_RESOURCES_FIELDS?= $(_CFN_SHOW_LAYER_RESOURCES_FIELDS)
_CFN_SHOW_STACK_STATUS_QUERYFILTER?= $(CFN_STACK_LAYER_QUERYFILTER)
_CFN_SHOW_STACK_STATUS_FIELDS?= .{CreationTime:CreationTime,StackName:StackName,StackStatus:StackStatus}
_CFN_SHOW_STACK_STATUS_FIELDS?= .{CreationTime:CreationTime,StackName:StackName,TemplateDescription:TemplateDescription,StackStatus:StackStatus}

_CFN_LIST_STACK_STATUS_FIELDS?= $(_CFN_SHOW_STACK_STATUS_FIELDS)
_CFN_WATCH_INTERVAL?= 5
_CFN_WATCH_STACK_EVENTS_FIELDS?= .[Timestamp,LogicalResourceId,ResourceStatus]
...
_cfn_list_targets ::
	...
	@echo '    _cfn_list_stacks                             - List all stacks'
	@echo '    _cfn_list_stacks_set                         - List a set of stacks'
	...
	@echo '    _cfn_show_stack_status                       - Show status of a stack'
	@echo '    _cfn_update_stack                            - Update the existing stack'
	@echo '    _cfn_watch_stack_events                      - Watch stack events as they come'
	@echo '    _cfn_watch_stack_reasons                     - Watch stack reasons as they come'
	@echo 
...
__cfn_show_stack_events_layer:
	...
	$(AWS) cloudformation describe-stack-events --stack-name $(CFN_STACK_LAYER_NAME) --query 'StackEvents[$(CFN_UI_LAYER_EVENT_SLICE)]$(_CFN_SHOW_STACK_EVENTS_FIELDS)' 2>/dev/null | tail -n+6

__cfn_show_stack_parameters_layer:
	echo -n '|  '; $(PURPLE) 'Layer: $(CFN_STACK_LAYER_NAME)'; $(WHITE) -n
	$(AWS) cloudformation describe-stacks --query "Stacks[?StackName=='$(CFN_STACK_LAYER_NAME)'].Parameters[]$(_CFN_SHOW_LAYER_PARAMETERS_FIELDS)" 2>/dev/null | tail -n+6

__cfn_show_stack_reasons_layer:
	echo -n '|  '; $(PURPLE) 'Layer: $(CFN_STACK_LAYER_NAME)'; $(WHITE) -n
	$(AWS) cloudformation describe-stack-events --stack-name $(CFN_STACK_LAYER_NAME) --query 'StackEvents[?ResourceStatusReason!=None]$(_CFN_SHOW_STACK_REASONS_FIELDS) | [$(CFN_UI_LAYER_REASON_SLICE)]' 2>/dev/null | tail -n+6

__cfn_show_stack_resources_layer:
	echo -n '|  '; $(PURPLE) 'Layer: $(CFN_STACK_LAYER_NAME)'; $(WHITE) -n
	$(AWS) cloudformation list-stack-resources  --stack-name $(CFN_STACK_LAYER_NAME) --query "StackResourceSummaries[]$(_CFN_SHOW_STACK_RESOURCES_FIELDS)" 2>/dev/null | tail -n+6
...
_cfn_cancel_stack_update:
	@$(INFO) '$(CFN_UI_LABEL)Canceling update of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	-$(AWS) cloudformation cancel-update-stack $(__CFN_STACK_NAME)

_cfn_continue_stack_rollback:
	@$(INFO) '$(CFN_UI_LABEL)Continue rolling back the stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	-$(AWS) cloudformation continue-update-rollback $(__CFN_RESOURCES_TO_SKIP) $(__CFN_ROLE_ARN) $(__CFN_STACK_NAME)

_cfn_create_stack:
	@$(INFO) '$(CFN_UI_LABEL)Creating stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
...
_cfn_enable_stack_termination_protection:
	@$(INFO) '$(CFN_UI_LABEL)Enabling termination protection for stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	$(AWS) cloudformation update-termination-protection --enable-termination-protection $(__CFN_STACK_NAME)

_cfn_delete_stack:
	@$(INFO) '$(CFN_UI_LABEL)Deleting stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
...
_cfn_disable_stack_termination_protection:
	@$(INFO) '$(CFN_UI_LABEL)Disabling termination protection for stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
...
_cfn_get_stack_output_value:
	@$(INFO) '$(CFN_UI_LABEL)Getting value of output "$(CFN_STACK_OUTPUT_NAME)" in stack-layer "$(CFN_STACK_LAYER_NAME)" ...'; $(NORMAL)
...
_cfn_list_stacks_set:


_CFN_SHOW_STACK_TARGETS?= _cfn_show_stack_events _cfn_show_stack_outputs _cfn_show_stack_parameters _cfn_show_stack_policy _cfn_show_stack_reasons _cfn_show_stack_resources _cfn_show_stack_status
_cfn_show_stack: $(_CFN_SHOW_STACK_TARGETS)

_cfn_show_stack_events:
	@$(INFO) '$(CFN_UI_LABEL)Showing events in stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	@$(AWS) cloudformation list-stacks $(__CFN_STACK_STATUS_FILTER) --query "StackSummaries[$(_CFN_SHOW_STACK_EVENTS_QUERYFILTER)]$(_CFN_SHOW_STACK_STATUS_FIELDS)"
...
_cfn_show_stack_outputs:
	@$(INFO) '$(CFN_UI_LABEL)Showing outputs of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	$(AWS) cloudformation describe-stacks --query "Stacks[$(CFN_STACK_LAYER_QUERYFILTER)].Outputs[]$(_CFN_SHOW_STACK_OUTPUTS_FIELDS)"

_cfn_show_stack_parameters:
	@$(INFO) '$(CFN_UI_LABEL)Showing parameters of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	@$(AWS) cloudformation list-stacks $(__CFN_STACK_STATUS_FILTER) --query "StackSummaries[$(_CFN_SHOW_STACK_EVENTS_QUERYFILTER)]$(_CFN_SHOW_STACK_STATUS_FIELDS)"
	@#$(WARN) 'Layers: $(CFN_STACK_LAYERS_NAMES)'; $(NORMAL)
	@$(foreach L, $(CFN_STACK_LAYERS_NAMES), \
...
_cfn_show_stack_policy:
	@$(INFO) '$(CFN_UI_LABEL)Showing policy of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	$(AWS) cloudformation get-stack-policy $(__CFN_STACK_NAME) 

_cfn_show_stack_reasons:
	@$(INFO) '$(CFN_UI_LABEL)Showing reasons of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	@$(AWS) cloudformation list-stacks $(__CFN_STACK_STATUS_FILTER) --query "StackSummaries[$(_CFN_SHOW_STACK_EVENTS_QUERYFILTER)]$(_CFN_SHOW_STACK_STATUS_FIELDS)"
	@#$(WARN) 'Layers: $(CFN_STACK_LAYERS_NAMES)'; $(NORMAL)
	@$(foreach L, $(CFN_STACK_LAYERS_NAMES), \
...
_cfn_show_stack_resources:
	@$(INFO) '$(CFN_UI_LABEL)Showing resources of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	@$(AWS) cloudformation list-stacks $(__CFN_STACK_STATUS_FILTER) --query "StackSummaries[$(_CFN_SHOW_STACK_EVENTS_QUERYFILTER)]$(_CFN_SHOW_STACK_STATUS_FIELDS)"
	@#$(WARN) 'Layers: $(CFN_STACK_LAYERS_NAMES)'; $(NORMAL)
	@$(foreach L, $(CFN_STACK_LAYERS_NAMES), \
...
_cfn_show_stack_status:
	@$(INFO) '$(CFN_UI_LABEL)Showing status for stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
	$(AWS) cloudformation list-stacks $(__CFN_STACK_STATUS_FILTER) --query "StackSummaries[$(_CFN_SHOW_STACK_STATUS_QUERYFILTER)]$(_CFN_SHOW_STACK_STATUS_FIELDS)"

_cfn_update_stack: 
	@$(INFO) '$(CFN_UI_LABEL)Updating stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
...
_cfn_update_stack_policy:
	@$(INFO) '$(CFN_UI_LABEL)Updating the policy of stack "$(CFN_STACK_NAME)" ...'; $(NORMAL)
...
_cfn_watch_stack_events:
	watch -n $(_CFN_WATCH_INTERVAL) --color "$(MAKE) -e --quiet _cfn_watch_stack_events_header _cfn_show_stack_events _cfn_watch_stack_events_footer"
...
_cfn_watch_stack_events:
	...
	@_MATCHED=0; while [ $${_MATCHED} -eq 0 ]; do \
		...
		echo -n '.' ; sleep 1 ; \
	done; $(INFO) "\n$(CFN_UI_LABEL)The stack operation on $(CFN_STACK_NAME) completed with status : $${_STACK_STATUS}"; $(NORMAL)
...
_cfn_watch_stack_reasons:
	watch -n $(_CFN_WATCH_INTERVAL) --color "$(MAKE) -e --quiet _cfn_show_stack_reasons"
