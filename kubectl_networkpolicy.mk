...
_kcl_view_framework_targets ::
	...
	@echo '    _kcl_view_networkpolicies                      - View network-policies'
	@echo '    _kcl_view_networkpolicies_set                  - View a set of network-policies'
...
_kcl_show_networkpolicy: _kcl_show_networkpolicy_description
...
_kcl_view_networkpolicies:
	@$(INFO) '$(KCL_UI_LABEL)Viewing ALL network-policies ...'; $(NORMAL)
	$(KUBECTL) get networkpolicies --all-namespaces=true $(_X__KCL_NAMESPACE__NETWORKPOLICIES) $(_X__KCL_SELECTOR_NETWORKPOLICIES)

_kcl_view_networkpolicies_set:
	@$(INFO) '$(KCL_UI_LABEL)Viewing network-policies-set "$(KCL_NETWORKPOLICIES_SET_NAME)" ...'; $(NORMAL)
