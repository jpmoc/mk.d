...
# __KCL_FROM_LITERAL__SECRET= $(foreach KV, $(KCL_SECRET_LITERALS_KEYVALUES),--from-literal $(KV))# This fails with spaces!
__KCL_FROM_LITERAL__SECRET?= $(if $(KCL_SECRET_LITERALS_KEYVALUES),--from-literal $(KCL_SECRET_LITERALS_KEYVALUES))# Only one key-value supported!
