...
# Customizations
_ACM_LIST_CERTIFICATEAUTHORITIES_FIELDS?= .{status:Status,Arn:Arn,subject: CertificateAuthorityConfiguration.Subject | join(' * ',values(@))}
...
_acm_list_targets ::
	...
	@echo '    _acm_list_certificateauthorities                 - List all certificate-authorities'
	@echo '    _acm_list_certificateauthorities_set             - List a set of certificate-authorities'
...
_acm_create_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Creating certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME) "...'; $(NORMAL)
...
_acm_delete_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Deleting certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_import_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Importing certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_issue_certificate_by_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Issuing certificate "$(ACM_CERTIFICATEAUTHORITY_CERTIFICATE_NAME)" by certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
	$(AWS) acm-pca issue-certificate $(__ACM_CERTIFICATE_AUTHORITY_ARN) $(__ACM_CSR) $(__ACM_SIGNING_ALGORITHM) $(__ACM_VALIDITY)

_acm_list_certificateauthorities:
	@$(INFO) '$(ACM_UI_LABEL)Listing ALL certificate-authorities ...'; $(NORMAL)
	$(AWS) acm-pca list-certificate-authorities --query "CertificateAuthorities[]$(_ACM_LIST_CERTIFICATEAUTHORITIES_FIELDS)"

_acm_list_certificateauthorities_set:
	@$(INFO) '$(ACM_UI_LABEL)Listing certificate-authorities-set "$(ACM_CERTIFICATEAUTHORITIES_SET_NAME)" ...'; $(NORMAL)
	$(AWS) acm-pca list-certificate-authorities --query "CertificateAuthorities[$(_ACM_LIST_CERTIFICATEAUTHORITIES_SET_SLICE)]$(_ACM_LIST_CERTIFICATEAUTHORITIES_SET_FIELDS)"

_acm_revoke_certificate_by_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Revoking certificate "$(ACM_CERTIFICATEAUTHORITY_CERTIFICATE_NAME)" by certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_ACM_SHOW_CERTIFICATEAUTHORITY_TARGETS?= _acm_show_certificateauthority_chain _acm_show_certificateauthority_csr _acm_show_certificateauthority_tags _acm_show_certificateauthority_description
_acm_show_certificateauthority: $(_ACM_SHOW_CERTIFICATEAUTHORITY_TARGETS)

_acm_show_certificateauthority_chain:
	@$(INFO) '$(ACM_UI_LABEL)Showing certificate-chain to certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_show_certificateauthority_csr:
	@$(INFO) '$(ACM_UI_LABEL)Showing certificate-signing-request of certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_show_certificateauthority_description:
	@$(INFO) '$(ACM_UI_LABEL)Showing description of certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
	$(AWS) acm-pca describe-certificate-authority $(__ACM_CERTIFICATE_AUTHORITY_ARN)

_acm_show_certificateauthority_tags:
	@$(INFO) '$(ACM_UI_LABEL)Showing tags of certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
	$(AWS) acm-pca list-tags $(__ACM_CERTIFICATE_AUTHORITY_ARN)

_acm_tag_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Tagging certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_untag_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Untagging certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
...
_acm_update_certificateauthority:
	@$(INFO) '$(ACM_UI_LABEL)Updating certificate-authority "$(ACM_CERTIFICATEAUTHORITY_NAME)" ...'; $(NORMAL)
