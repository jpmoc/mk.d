...
DKR_IMAGE_DELETEFORCE_FLAG?= false
...
DKR_IMAGE_DIGEST?= $(if $(DKR_IMAGE_SHA256),sha256:$(DKR_IMAGE_SHA256))
...
#DKR_IMAGE_ID?= $(DKR_IMAGE_SHA256)# This is wrong!
...
__DKR_DIGESTS= $(if $(filter true, $(DKR_IMAGES_DIGESTS_FLAG)),--digests)
...
__DKR_FORCE__IMAGE= $(if $(filter true, $(DKR_IMAGE_DELETEFORCE_FLAG)),--force)
...
_dkr_list_parameters ::
	...
	@echo '    DKR_IMAGE_DELETEFORCE_FLAG=$(DKR_IMAGE_DELETEFORCE_FLAG)'
	...
	@echo '    DKR_IMAGES_DIGESTS_FLAG=$(DKR_IMAGES_DIGEST_FLAG)'
