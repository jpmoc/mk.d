...
_install_framework_dependencies :: _sfd_install_framework_dependencies
_sfd_install_framework_dependencies ::
...
_view_framework_macros :: _sfd_view_framework_macros
_sfd_view_framework_macros ::
	@#echo 'SkaFfolD:: ($(_SKAFFOLD_MK_VERSION)) macros:'
	@#echo

_view_framework_parameters :: _sfd_view_framework_parameters
...
_view_framework_targets :: _sfd_view_framework_targets
...
MK_DIR?= .
-include $(MK_DIR)/skaffold_application.mk
-include $(MK_DIR)/skaffold_artifact.mk
-include $(MK_DIR)/skaffold_config.mk
-include $(MK_DIR)/skaffold_profile.mk
-include $(MK_DIR)/skaffold_userconfig.mk
