...
KCL_NAMESPACE_LABEL_OVERWRITE?= false
...
__KCL_OVERWRITE__NAMESPACE= $(if $(filter true,$(KCL_NAMESPACE_LABEL_OVERWRITE)),--overwrite)
...
_kcl_view_framework_parameters ::
	...
	@echo '    KCL_NAMESPACE_LABEL_OVERWRITE=$(KCL_NAMESPACE_LABEL_OVERWRITE)'
...
_kcl_label_namespace:
	@$(INFO) '$(KCL_UI_LABEL)Labelling namespace "$(KCL_NAMESPACE_NAME)" ...'; $(NORMAL)
...
_kcl_unlabel_namespace:
	...
	$(KUBECTL) label namespace $(strip $(_X__KCL_DRY_RUN__NAMESPACE) $(__KCL_OVERWRITE__NAMESPACE) $(__KCL_RESOURCE_VERSION__NAMESPACE) $(KCL_NAMESPACE_NAME) $(X_KCL_NAMESPACE_LABELS_KEYVALUES) $(foreach K,$(KCL_NAMESPACE_LABELS_KEYS),$(K)- ) )
