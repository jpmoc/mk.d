...
# Customizations
_SCG_CREATE_CONSTRAINT_FIELDS?= .{ConstraintId:ConstraintDetail.ConstraintId,Type:ConstraintDetail.Type,owner:ConstraintDetail.Owner,status:Status,zdescription:ConstraintDetail.Description}
_SCG_SHOW_CONSTRAINT_FIELDS?= .{ConstraintId:ConstraintDetail.ConstraintId,Type:ConstraintDetail.Type,owner:ConstraintDetail.Owner,status:Status,zdescription:ConstraintDetail.Description}
...
_scg_list_targets ::
	...
	@echo '    _scg_list_constraints                      - List all constraints'
	@echo '    _scg_list_constraints_set                  - List a set of constraints'
...
_scg_list_constraints:
	@$(INFO) '$(SCG_UI_LABEL)Listing ALL product-constraints ...'; $(NORMAL)
	@$(ERROR) 'Constraints can only be listed against a product or portfolio!'; $(NORMAL)

_scg_list_constraints_set:
	@$(INFO) '$(SCG_UI_LABEL)Listing product-constraints-set "$(SCG_CONSTRAINTS_SET_NAME)"...'; $(NORMAL)

_SCG_SHOW_CONSTRAINT_TARGETS?= _scg_show_constraint_rules _scg_show_constraint_description
_scg_show_constraint: $(_SCG_SHOW_CONSTRAINT_TARGETS)
