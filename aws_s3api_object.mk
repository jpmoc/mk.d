...
_s3i_view_framework_targets ::
	...
	@echo '    _s3i_view_objects                           - View objects in objects'
	@echo
...
_s3i_create_object:
	@$(INFO) '$(AWS_UI_LABEL)Creating object "$(S3I_OBJECT_NAME)" ...'; $(NORMAL)
...
_s3i_delete_object:
	@$(INFO) '$(AWS_UI_LABEL)Deleting object "$(S3I_OBJECT_NAME)" ...'; $(NORMAL)
...
_s3i_delete_objects:
	@$(INFO) '$(AWS_UI_LABEL)Deleting objects ...'; $(NORMAL)
...
_s3i_show_object_description:
	@$(INFO) '$(AWS_UI_LABEL)Showing description of object "$(S3I_OBJECT_NAME)" ...'; $(NORMAL)

_s3i_view_objects:
	@$(INFO) '$(AWS_UI_LABEL)Viewing objects ...'; $(NORMAL)
	$(AWS) s3api list-objects $(__S3I_BUCKET__OBJECTS) $(__S3I_DELIMITER) $(__S3I_ENCODING_TYPE) $(__S3I_FETCH_OWNER) $(__S3I_PREFIX)$(__S3I_REQUEST_PAYER) $(__S3I_START_AFTER)  # --query "Buckets[]$(S3I_UI_VIEW_OBJECTS_FIELDS)"
