...
# Customizations
_IAM_LIST_INLINEPOLICIES_FIELDS?=
_IAM_LIST_INLINEPOLICIES_SET_FIELDS?= $(_IAM_LIST_INLINEPOLICIES_FIELDS)
_IAM_LIST_INLINEPOLICIES_SET_QUERYFILTER?=
...
_iam_list_targets ::
	...
	@echo '    _iam_list_inlinepolicies                  - List all inline-policies'
	@echo '    _iam_list_inlinepolicies_set              - List a set of inline-policies'
	@echo
...
_iam_list_inlinepolicies:
	@$(INFO) '$(IAM_UI_LABEL)Listing ALL inline-policies ...'; $(NORMAL)
...
_iam_list_inlinepolicies_set:
	@$(INFO) '$(IAM_UI_LABEL)Listing inline-policies-set "$(IAM_INLINEPOLICIES_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'Inline-policies are grouped based on the provided query-filter'; $(NORMAL)
	$(if $(IAM_INLINEPOLICIES_GROUP_NAME),$(AWS) iam list-group-policies $(__IAM_GROUP_NAME__INLINEPOLICIES) --query 'PolicyNames[$(_IAM_LIST_INLINEPOLICIES_SET_QUERYFILTER)]')
	$(if $(IAM_INLINEPOLICIES_ROLE_NAME),$(AWS) iam list-role-policies $(__IAM_ROLE_NAME__INLINEPOLICIES) --query 'PolicyNames[$(_IAM_LIST_INLINEPOLICIES_SET_QUERYFILTER)]')
	$(if $(IAM_INLINEPOLICIES_USER_NAME),$(AWS) iam list-user-policies $(__IAM_USER_NAME__INLINEPOLICIES) --query 'PolicyNames[$(_IAM_LIST_INLINEPOLICIES_SET_QUERYFILTER)]')

_IAM_SHOW_INLINEPOLICY_TARGETS?= _iam_show_inlinepolicy_document _iam_show_inlinepolicy_description
_iam_show_inlinepolicy: $(_IAM_SHOW_INLINEPOLICY_TARGETS)
