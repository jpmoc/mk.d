...
# Customizations
_LBA_LIST_LAYERVERSIONS_FIELDS?=
_LBA_LIST_LAYERVERSIONS_SET_FIELDS?= $(LBA_LIST_LAYERVERSIONS_FIELDS)
_LBA_LIST_LAYERVERSIONS_SET_QUERY_FILTER?=
...
_lba_list_targets ::
	...
	@echo '    _lba_list_layerversions                   - List all layer-versions'
	@echo '    _lba_list_layerversions_set               - List a set of layer-versions' 
...
_lba_list_layerversions:
	@$(INFO) '$(AWS_UI_LABEL)Listing ALL versions of layer "$(LBA_LAYERVERSION_LAYER_NAME)"  ...'; $(NORMAL)
	$(AWS) lambda list-layer-versions $(_X__LBA_COMPATIBLE_RUNTIME) $(__LBA_LAYER_NAME__LAYERVERSION) # --query 'EventSourceMappings[]$(_LBA_LIST_LAYERS_FIELDS)'

_lba_list_layerversions_set:
	@$(INFO) '$(AWS_UI_LABEL)Listing layer-versions-set "$(LBA_LAYERVERSIONS_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'Layer-versions are grouped based on layer, compatible-runtime, query filter, ...'; $(NORMAL)
	$(AWS) lambda list-layer-versions $(__LBA_COMPATIBLE_RUNTIME) $(__LBA_LAYER_NAME__LAYERVERSION) # --query 'EventSourceMappings[$(_LBA_LIST_LAYERVERSIONS_SET_QUERYFILTER)]$(_LBA_LIST_LAYERVERSIONS_SET_FIELDS)'
...
_LBA_SHOW_LAYERVERSION_TARGETS?= _lba_show_layerversion_policy _lba_show_layerversion_description
_lba_show_layerversion: $(_LBA_SHOW_LAYERVERSION_TARGETS)
