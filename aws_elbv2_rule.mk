...
# UI parameters
ELB2_UI_VIEW_RULES_FIELDS?= .{RuleArn:RuleArn,priority:Priority,isDefault:IsDefault}
ELB2_UI_VIEW_RULES_SET_FIELDS?= $(ELB2_UI_VIEW_RULES_FIELDS)
ELB2_UI_VIEW_RULES_SET_QUERYFILTER?=
...
_elb2_view_framework_targets ::
	...
	@echo '    _elb2_view_rules                            - View all rules'
	@echo '    _elb2_view_rules_set                        - View a set of rules'
...
_elb2_show_rule: _elb2_show_rule_targetgroup _elb2_show_rule_description
...
_elb2_view_rules:
	@$(INFO) '$(ELB2_UI_LABEL)Viewing ALL listener-rules ...'; $(NORMAL)
	@$(WARN) 'Rules are grouped based on the provided listener ARN'; $(NORMAL)
	$(AWS) elbv2 describe-rules $(__ELB2_LISTENER_ARN__RULES) $(_X_ELB2_RULE_ARNS__RULES) --query "Rules[]$(ELB2_UI_VIEW_RULES_FIELDS)"

_elb2_view_rules_set:
	@$(INFO) '$(ELB2_UI_LABEL)Viewing rules-set "$(ELB2_RULES_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'Rules are grouped based on the provided listener ARN, rule ARNs, and query-filter'; $(NORMAL)
	$(AWS) elbv2 describe-rules $(__ELB2_LISTENER_ARN__RULES) $(__ELB2_RULE_ARNS__RULES) # --query "Rules[$(ELB2_UI_VIEW_RULES_SET_QUERYFILTER)]$(ELB2_UI_VIEW_RULES_SET_FIELDS)"
