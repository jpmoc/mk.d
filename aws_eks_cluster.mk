...
# UI parameters
EKS_SHOW_CLUSTER_DESCRIPTION_FIELDS?= .{status:status,endpoint:endpoint,identity:identity,logging:logging,name:name,platformVersion:platformVersion,rolearn:roleArn,version:version,arn:arn,createdAt:createdAt,resourcesVpcConfig:resourcesVpcConfig}
EKS_UI_VIEW_CLUSTERS_FIELDS?=
EKS_UI_VIEW_CLUSTERS_SET_FIELDS?= $(EKS_UI_VIEW_CLUSTERS_FIELDS)
EKS_UI_VIEW_CLUSTERS_SET_QUERYFILTER?=
...
_eks_view_framework_targets ::
	...
	@echo '    _eks_view_clusters                           - View all existing clusters'
	@echo '    _eks_view_clusters_set                       - View a set of clusters'
	@echo 
...
_eks_show_cluster: _eks_show_cluster_addons _eks_show_cluster_certificateauthority _eks_show_cluster_fargateprofiles _eks_show_cluster_idpconfigs _eks_show_cluster_nodegroups _eks_show_cluster_tags _eks_show_cluster_token _eks_show_cluster_description
...
_eks_show_cluster_description:
	...
	$(AWS) eks describe-cluster $(__EKS_NAME__CLUSTER) --query "cluster$(EKS_SHOW_CLUSTER_DESCRIPTION_FIELDS)"
...
_eks_view_clusters:
	@$(INFO) '$(EKS_UI_LABEL)Viewing ALL clusters ...'; $(NORMAL)
	$(AWS) eks list-clusters --query "clusters[]$(EKS_UI_VIEW_CLUSTERS_FIELDS)"

_eks_view_clusters_set:
	@$(INFO) '$(EKS_UI_LABEL)Viewing clusters-set "$(EKS_CLUSTERS_SET_NAME)" ...'; $(NORMAL)
