...
# Customizations
_EC2_LIST_NETWORKINTERFACES_FIELDS?= .[TagSet[?Key=='Name']|[0].Value,NetworkInterfaceId,VpcId,SubnetId,AvailabilityZone,PrivateIpAddress,Status,Attachment.InstanceId]
...
_ec2_list_targets ::
	...
	@echo '    _ec2_list_networkinterfaces                - List all network-interfaces'
	@echo '    _ec2_list_networkinterfaces_set            - List set of network-interfaces'
	@echo 
...
_ec2_list_networkinterfaces:
	@$(INFO) '$(EC2_UI_LABEL)Listing network-interfaces...'; $(NORMAL)
	$(AWS) ec2 describe-network-interfaces $(_X__EC2_FILTER) $(__EC2_NETWORK_INTERFACE_IDS__NETWORKINTERFACES) --query "NetworkInterfaces[$(_EC2_LIST_NETWORKINTERFACES_QUERYFILTER)]$(_EC2_LIST_NETWORKINTERFACES_FIELDS)"

_ec2_list_networkinterfaces_set:
	@$(INFO) '$(EC2_UI_LABEL)Listing network-interfaces-set "$(EC2_NETWORKINTERFACES_SET_NAME)" ...'; $(NORMAL)
	$(AWS) ec2 describe-network-interfaces $(__EC2_NETWORK_INTERFACE_IDS__NETWORKINTERFACES) $(__EC2_FILTERS__NETWORKINTERFACES) --query "NetworkInterfaces[$(_EC2_LIST_NETWORKINTERFACES_QUERYFILTER)]$(_EC2_LIST_NETWORKINTERFACES_FIELDS)"

_EC2_SHOW_NETWORKINTERFACE_TARGETS?= _ec2_show_networkinterface_attributes _ec2_show_networkinterface_securitygroups _ec2_show_networkinterface_description
_ec2_show_networkinterface: $(_EC2_SHOW_NETWORKINTERFACE_TARGETS)
