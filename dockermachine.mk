...
_docker_view_framework_macros :: _dme_view_framework_macros
_dme_view_framework_macros ::
	@echo "Docker::Machine ($(_DOCKER_MACHINE_MK_VERSION)) macros:"
	@echo "     _dme_get_ip             - Return the IP of the current machine"
	@echo "     _dme_get_ip_N           - Return the IP of a given machine"
	@echo

_docker_view_framework_parameters :: _dme_view_framework_parameters
_dme_view_framework_parameters ::
	@echo "Docker::Machine ($(_DOCKER_MACHINE_MK_VERSION)) variables:"
...
_docker_view_framework_targets :: _dme_view_framework_targets
_dme_view_framework_targets ::
	@echo "Docker::Machine ($(_DOCKER_MACHINE_MK_VERSION)) targets:"
	...
	@echo "    _dme_show_version               - Get the version of docker-machine"
...
_dme_show_version:
	@$(INFO) "$(DME_UI_LABEL)Getting version ..."; $(NORMAL)
