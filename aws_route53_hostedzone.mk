...
# R53_HOSTEDZONE_VPCREGION_ID?= us-west-1
# R53_HOSTEDZONES_SET_NAME?= my-hosted-zones-set

# Derived parameters
R53_HOSTEDZONE_VPC?= $(if $(R53_HOSTEDZONE_VPC_ID),VPCRegion=$(R53_HOSTEDZONE_VPCREGION_ID)$(COMMA)VPCId=$(R53_HOSTEDZONE_VPC_ID))
R53_HOSTEDZONE_VPC_ID?= $(EC2_VPC_ID)
R53_HOSTEDZONE_VPC_REGION?= $(AWS_REGION_ID)
...
# Customizations
_R53_LIST_HOSTEDZONES_FIELDS?= .{Id:Id,Name:Name,resourceRecordSetCount:ResourceRecordSetCount,privateZone:Config.PrivateZone,callerReference:CallerReference}
...
_r53_list_parameters ::
	...
	@echo '    R53_HOSTEDZONE_VPCREGION_ID=$(R53_HOSTEDZONE_VPCREGION_ID)'
	@echo '    R53_HOSTEDZONES_SET_NAME=$(R53_HOSTEDZONES_SET_NAME)'
	@echo
...
_r53_list_targets ::
	...
	@echo '    _r53_list_hostedzones                      - List all hosted-zones'
	@echo '    _r53_list_hostedzones_set                  - List a set of hosted-zones'
...
_r53_associate_vpc_with_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Associating VPC to hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	$(AWS) route53 associate-vpc-with-hosted-zone $(__R53_COMMENT) $(__R53_HOSTED_ZONE_ID) $(__R53_VPC)

_r53_create_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Creating hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	@$(WARN) 'This operation will fail if the hosted-zone already exist'; $(NORMAL)
	@$(WARN) 'This operation will fail if the caller-reference has previously been used'; $(NORMAL)
...
_r53_delete_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Deleting hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	$(AWS) route53 delete-hosted-zone $(__R53_ID__HOSTEDZONE)

_r53_disassociate_vpc_from_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Disassociating VPC from hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	$(AWS) route53 disassociate-vpc-from-hosted-zone $(__R53_COMMENT) $(__R53_HOSTED_ZONE_ID) $(__R53_VPC)

_r53_list_hostedzones:
	@$(INFO) '$(R53_UI_LABEL)Listing ALL hosted-zones ...'; $(NORMAL)
	$(AWS) route53 list-hosted-zones --query "HostedZones[]$(_R53_LIST_HOSTEDZONES_FIELDS)"

_r53_list_hostedzones_set:
	@$(INFO) '$(R53_UI_LABEL)Listing hosted-zones-set "$(R53_HOSTEDZONES_SET_NAME)" ...'; $(NORMAL)

_R53_SHOW_HOSTEDZONE_TARGETS?= _r53_show_hostedzone_limits _r53_show_hostedzone_localhost _r53_show_hostedzone_description
_r53_show_hostedzone: $(_R53_SHOW_HOSTEDZONE_TARGETS)

_r53_show_hostedzone_description:
	@$(INFO) '$(R53_UI_LABEL)Showing description of hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	$(AWS) route53 get-hosted-zone $(__R53_ID__HOSTEDZONE)

_r53_show_hostedzone_limits:
	@$(INFO) '$(R53_UI_LABEL)Showing record-limit of hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	$(AWS) route53 get-hosted-zone-limit $(__R53_HOSTED_ZONE_ID) $(_X_R53_TYPE) --type MAX_RRSETS_BY_ZONE
	@$(INFO) '$(R53_UI_LABEL)Showing VPC-limit of hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	@$(WARN) 'This operation will fail if the hosted-zone is not a private one'; $(NORMAL)
...
_r53_show_hostedzone_localhost:
	@$(INFO) '$(R53_UI_LABEL)Showing from localhost the hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
	@$(WARN) 'This operation will fail for PRIVATE hosted-zone'; $(NORMAL)
...
_r53_show_hostedzone_trafficpolicyinstance:
	@$(INFO) '$(R53_UI_LABEL)Showing traffic-policy-instance of hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
...
_r53_tag_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Tagging hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
...
_r53_untag_hostedzone:
	@$(INFO) '$(R53_UI_LABEL)Untagging hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
...
_r53_update_hostedzone_comment:
	@$(INFO) '$(R53_UI_LABEL)Updating comment of hosted-zone "$(R53_HOSTEDZONE_NAME)" ...'; $(NORMAL)
