...
# SFD_ARTIFACTS_KUBECONFIG_FILEPATH?= $(HOME)/.kube/config
...
SFD_ARTIFACTS_KUBECONFIG_FILEPATH?= $(SFD_KUBECONFIG_FILEPATH)
SFD_ARTIFACTS_NAMESPACE_NAME?= $(SFD_NAMESPACE_NAME)
...
__SFD_KUBECONFIG__ARTIFACTS= $(if $(SFD_ARTIFACTS_KUBECONFIG_FILEPATH),--kubeconfig $(SFD_ARTIFACTS_KUBECONFIG_FILEPATH))
__SFD_NAMESPACE__ARTIFACTS= $(if $(SFD_ARTIFACTS_NAMESPACE_FILEPATH),--namespace $(SFD_ARTIFACTS_NAMESPACE_NAME))
...
_sfd_list_parameters ::
	...
	@echo '    SFD_ARTIFACTS_KUBECONFIG_FILEPATH=$(SFD_ARTIFACTS_KUBECONFIG_FILEPATH)'
	@echo '    SFD_ARTIFACTS_NAMESPACE_NAME=$(SFD_ARTIFACTS_NAMESPACE_NAME)'
