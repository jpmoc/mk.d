...
# Derived variables
IAM_USER_ACCOUNT_ID?= $(IAM_ACCOUNT_ID)
IAM_USER_ARN?= $(if $(IAM_USER_NAME),arn:aws:iam::$(IAM_USER_ACCOUNT_ID):user/$(IAM_USER_NAME))
...
_iam_view_framework_parameters ::
	...
	@echo '    IAM_USER_ACCOUNT_ID=$(IAM_USER_ACCOUNT_ID)'
