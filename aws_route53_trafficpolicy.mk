...
LIST_HEALTH_CHECK_STATUS_FIELDS?=.[StatusReport.CheckedTime,StatusReport.Status,IPAddress]
...
_aws_list_macros :: _r53_list_macros
_r53_list_macros:
...
_aws_list_parameters :: _r53_list_parameters
...
_aws_list_targets :: _r53_list_targets
_r53_list_targets:
...
_r53_describe_health_checks:
	...
	$(AWS) route53 list-health-checks $(__FILTER) --query "HealthChecks[]$(DESCRIBE_HEALTH_CHECKS_FIELDS)"

_r53_get_health_check_status:
	@$(INFO) '$(AWS_LABEL)Reporting on the status of $(R53_HEALTH_CHECK_ID) ...'; $(NORMAL)
	$(AWS)  route53 get-health-check-status $(__HEALTH_CHECK_ID) --query "HealthCheckObservations[]$(LIST_HEALTH_CHECK_STATUS_FIELDS)"
