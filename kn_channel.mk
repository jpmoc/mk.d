...
_kn_view_framework_targets ::
	...
	@echo '    _kn_view_channels                   - View all channels'
	@echo '    _kn_view_channels_set               - View a set of channels'
...
_kn_view_channels:
	@$(INFO) '$(KN_UI_LABEL)Viewing channels ...'; $(NORMAL)
	$(KN) channel list --all-namespaces=true $(_X__KN_NAMESPACE__CHANNELS) $(__KN_TARGET__CHANNELS)

_kn_view_channels_set:
	@$(INFO) '$(KN_UI_LABEL)Viewing channels-set "$(KN_CHANNELS_SET_NAME)" ...'; $(NORMAL)
