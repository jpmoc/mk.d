...
_scg_list_targets ::
	...
	@echo '    _scg_list_provisionedproductplans                            - List all provisioned-product-plans'
	@echo '    _scg_list_provisionedproductplans_set                        - List a set of provisioned-product-plans'
...
_scg_list_provisionedproductplans:
	@$(INFO) '$(SCG_UI_LABEL)Listing ALL provisioned-product-plans ...'; $(NORMAL)
	$(AWS) servicecatalog list-provisioned-product-plans $(__SCG_ACCEPT_LANGUAGE) $(__SCG_PROVISION_PRODUCT_ID)

_scg_list_provisionedproductplans_set:
	@$(INFO) '$(SCG_UI_LABEL)Listing provisioned-product-plans-set "$(SCG_PROVISIONEDPRODUCTPLANS_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'Provisioned-product plans are grouped based on ...'; $(NORMAL)
	$(AWS) servicecatalog list-provisioned-product-plans $(__SCG_ACCEPT_LANGUAGE) $(__SCG_PROVISION_PRODUCT_ID)

_SCG_SHOW_PROVISIONEDPRODUCTPLAN_TARGETS?= _scg_show_provisionedproductplan_description
_scg_show_provisionedproductplan: $(_SCG_SHOW_PROVISIONEDPRODUCTPLAN_TARGETS)
