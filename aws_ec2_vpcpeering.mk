...
_ec2_view_framework_targets ::
	...
	@echo "    _ec2_create_vpcpeering                     - Initiate a VPC-peering connection with another VPC"
	@echo "    _ec2_delete_vpcpeering                     - Delete an existing VPC-peering connection"
	@echo "    _ec2_reject_vpcpeering                     - Reject a VPC-peering connection"
	@echo "    _ec2_show_peer_vpc                         - Show details on the peer VPC"
	@echo "    _ec2_show_vpcpeering                       - Show the details of a VPC-peering connection"
	@echo "    _ec2_tag_vpcpeering                        - Tag a VPC-peering-connection"
	@echo "    _ec2_view_vpcpeerings                      - View all the existing VPC-peering connections"
	@echo 
...
_ec2_show_peer_vpc: override EC2_VPC_ID=$(EC2_PEER_VPC_ID)
_ec2_show_peer_vpc: override EC2_VPC_NAME=$(EC2_PEER_VPC_NAME)
_ec2_show_peer_vpc: _ec2_show_vpc

_ec2_show_vpcpeering:
	@$(INFO) "$(EC2_UI_LABEL)Show VPC-peering connection '$(EC2_VPCPEERING_NAME)' ..."; $(NORMAL)
...
_ec2_view_vpcpeerings:
	@$(INFO) "$(EC2_UI_LABEL)View VPC-peering connections ..."; $(NORMAL)
	$(AWS) ec2 describe-vpc-peering-connections $(__EC2_VPC_PEERING_CONNECTION_IDS) --query "VpcPeeringConnections[]$(EC2_UI_VIEW_PEERINGS_FIELDS)"
