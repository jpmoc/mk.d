...
_kn_view_framework_targets ::
	...
	@echo '    _kn_view_brokers                   - View all brokers'
	@echo '    _kn_view_brokers_set               - View a set of brokers'
...
_kn_show_broker: _kn_show_broker_description
...
_kn_view_brokers:
	@$(INFO) '$(KN_UI_LABEL)Viewing brokers ...'; $(NORMAL)
	$(KN) broker list --all-namespaces=true $(_X__KN_NAMESPACE__BROKERS) $(__KN_TARGET__BROKERS)

_kn_view_brokers_set:
	@$(INFO) '$(KN_UI_LABEL)Viewing brokers-set "$(KN_BROKERS_SET_NAME)" ...'; $(NORMAL)
