...
# UI parameters
SCG_UI_VIEW_RECORDS_FIELDS?= .{RecordId:RecordId,createdTime:CreatedTime,recordType:RecordType,status:Status,provisionedProductName:ProvisionedProductName,updatedTime:UpdatedTime}
SCG_UI_VIEW_RECORDS_SET_FIELDS?= $(SCG_UI_VIEW_RECORDS_FIELDS)
SCG_UI_VIEW_RECORDS_SET_SLICE?=
...
_scg_view_framework_targets ::
	...
	@echo '    _scg_view_records                          - View all records'
	@echo '    _scg_view_records_set                      - View set of records'
	@echo 
...
_scg_show_record: _scg_show_record_description
...
_scg_view_records:
	@$(INFO) '$(SCG_UI_LABEL)Viewing ALL records ...'; $(NORMAL)
...
_scg_view_records_set:
	@$(INFO) '$(SCG_UI_LABEL)Viewing records-set "$(SCG_RECORDS_SET_NAME)" ...'; $(NORMAL)
