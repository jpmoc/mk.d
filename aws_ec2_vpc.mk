...
# UI parameters
EC2_UI_SHOW_VPC_FIELDS?=
# EC2_UI_VIEW_VPCS_FIELDS?= .[Tags[?Key=='Name']|[0].Value,VpcId,State,CidrBlock,IsDefault]
EC2_UI_VIEW_VPCS_FIELDS?= .{Name:Tags[?Key=='Name']|[0].Value || '',VpcId:VpcId,state:State,cidrBlock:CidrBlock,isDefault:IsDefault}
EC2_UI_VIEW_VPCS_SET_FIELDS?= $(EC2_UI_VIEW_VPCS_FIELDS)
EC2_UI_VIEW_VPCS_SET_QUERYFILTER?=
...
_ec2_view_framework_targets ::
	...
	@echo '    _ec2_show_vpc                          - Show details of a VPC'
	...
	@echo '    _ec2_view_vpcs                         - View existing VPCs'
	@echo '    _ec2_view_vpcs_set                     - View a set of VPCs'
	@echo 
...
_ec2_create_vpc:
	@$(INFO) '$(EC2_UI_LABEL)Creating a new VPC "$(EC2_VPC_NAME)" ...'; $(NORMAL)
...
_ec2_show_vpc: _ec2_show_vpc_networkinterfaces _ec2_show_vpc_securitygroups _ec2_show_vpc_subnets _ec2_show_vpc_tags _ec2_show_vpc_description

_ec2_show_vpc_description:
	@$(INFO) '$(EC2_UI_LABEL)Showing description of VPC "$(EC2_VPC_NAME)"...'; $(NORMAL)
	$(AWS) ec2 describe-vpcs --filters Name=vpc-id,Values=$(EC2_VPC_ID) $(_X__EC2_VPC_IDS) --query "Vpcs[]$(EC2_UI_SHOW_VPC_FIELDS)"
...
_ec2_view_vpcs:
	@$(INFO) '$(EC2_UI_LABEL)Viewing existing VPCs ...'; $(NORMAL)
	$(AWS) ec2 describe-vpcs $(_X__EC2_FILTERS_VPC) $(_X__EC2_VPC_IDS) --query "Vpcs[]$(EC2_UI_VIEW_VPCS_FIELDS)"

_ec2_view_vpcs_set:
	@$(INFO) '$(EC2_UI_LABEL)Viewing a VPCs-set "$(EC2_VPCS_SET_NAME)" ...'; $(NORMAL)
	@$(WARN) 'VPCs are grouped based on the provided IDs, filters, and/or slice'; $(NORMAL)
	$(AWS) ec2 describe-vpcs $(__EC2_FILTERS_VPC) $(__EC2_VPC_IDS) --query "Vpcs[$(EC2_UI_VIEW_VPCS_SET_QUERYFILTER)]$(EC2_UI_VIEW_VPCS_SET_FIELDS)"
