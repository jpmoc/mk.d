...
# KCL_RULE_MANIFEST_DIRPATH?= ./in/
# KCL_RULE_MANIFEST_FILENAME?= rule.yaml
# KCL_RULE_MANIFEST_FILEPATH?= ./in/rule.yaml
# KCL_RULE_NAME?=
...
# Derived parameters
KCL_RULE_MANIFEST_DIRPATH?= $(KCL_INPUTS_DIRPATH)
KCL_RULE_MANIFEST_FILEPATH?= $(KCL_RULE_MANIFEST_DIRPATH)$(KCL_RULE_MANIFEST_FILENAME)
...
__KCL_FILENAME__RULE= $(if $(KCL_RULE_MANIFEST_FILEPATH),--filename $(KCL_RULE_MANIFEST_FILEPATH))
...
_kcl_view_framework_parameters ::
	...
	@echo '    KCL_RULE_MANIFEST_DIRPATH=$(KCL_RULE_MANIFEST_DIRPATH)'
	@echo '    KCL_RULE_MANIFEST_FILENAME=$(KCL_RULE_MANIFEST_FILENAME)'
	@echo '    KCL_RULE_MANIFEST_FILEPATH=$(KCL_RULE_MANIFEST_FILEPATH)'
...
_kcl_view_framework_targets ::
	...
	@echo '    _kcl_view_rules                   - View all rules'
	@echo
...
_kcl_apply_rule:
	...
	$(KUBECTL) apply $(__KCL_FILENAME__RULE) $(__KCL_NAMESPACE__RULE)
...
_kcl_show_rule: _kcl_show_rule_object _kcl_show_rule_state _kcl_show_rule_description
...
_kcl_unapply_rule:
	@$(INFO) '$(KCL_UI_LABEL)Un-applying manifest for rule "$(KCL_RULE_NAME)" ...'; $(NORMAL)
	cat $(KCL_RULE_MANIFEST_FILEPATH)
	$(KUBECTL) apply $(__KCL_FILENAME__RULE) $(__KCL_NAMESPACE__RULE)
...
_kcl_view_rules:
	@$(INFO) '$(KCL_UI_LABEL)Viewing ALL rules ...'; $(NORMAL)
...
_kcl_view_rules_set:
	@$(INFO) '$(KCL_UI_LABEL)Viewing rules-set "$(KCL_RULES_SET_NAME)" ...'; $(NORMAL)
...
_kcl_watch_rules:
	@$(INFO) '$(KCL_UI_LABEL)Watching rules ...'; $(NORMAL)
