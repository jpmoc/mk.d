...
# DKR_CONTAINER_COPYFOLLOWLINK_FLAG?= false
...
# DKR_CONTAINER_REMOVEVOLUMES_FLAG?= true
...
# DKR_CONTAINER_RUNATTACH_STREAMS?=i stdin stdout stderr
DKR_CONTAINER_RUNAUTOREMOVAL_FLAG?= flase
DKR_CONTAINER_RUNDETACH_FLAG?= false
# DKR_CONTAINER_RUNENVIRONMENT_KEYVALUES?= ZA_Server=172.17.1.42 ...
# DKR_CONTAINER_RUNINTERACTIVE_FLAG?= true
# DKR_CONTAINER_RUNPUBLISH_PORTS?= 127.0.0.1:8080:80/tcp ...
DKR_CONTAINER_RUNPUBLISHEXPOSEDPORTS_FLAG?= false
# DKR_CONTAINER_RUNTTY_FLAG?= true
...
DKR_CONTAINER_TAILDETAILS_FLAG?= false
DKR_CONTAINER_TAILFOLLOW_FLAG?= false
# DKR_CONTAINER_TAILHISTORY_COUNT?= 10
DKR_CONTAINER_TAILTIMESTAMPS_FLAG?= false
...
__DKR_ATTACH= $(foreach S, $(DKR_CONTAINER_RUNATTACH_STREAMS),--attach $(S))
...
__DKR_DETACH= $(if $(filter true, $(DKR_CONTAINER_RUNDETACH_FLAG)),--detach)
__DKR_DETAILS= $(if $(filter true, $(DKR_CONTAINER_TAILDETAILS_FLAG)),--details)
__DKR_ENV= $(if $(DKR_CONTAINER_RUNENVIRONMENT_KEYVALUES),--env $(DKR_CONTAINER_RUNENVIRONMENT_KEYVALUES))
__DKR_FILTER__CONTAINERS= $(foreach F, $(DKR_CONTAINERS_FILTER_KEYVALUES),--filter $(F))
__DKR_FOLLOW= $(if $(filter true, $(DKR_CONTAINER_TAILFOLLOW_FLAG)),--follow)
__DKR_FOLLOW_LINK= $(if $(filter true, $(DKR_CONTAINER_COPYFOLLOWLINK_FLAG)),--follow-link)
__DKR_FORCE= $(if $(filter true, $(DKR_CONTAINER_DELETEFORCE_FLAG)),--force)
__DKR_HOSTNAME= $(if $(DKR_CONTAINER_HOSTNAME),--hostname $(DKR_CONTAINER_HOSTNAME))
__DKR_INTERACTIVE= $(if $(filter true, $(DKR_CONTAINER_RUNINTERACTIVE_FLAG)),--interactive)
...
__DKR_NO_STREAM=
__DKR_NO_TRUNC=
__DKR_PUBLISH= $(foreach P, $(DKR_CONTAINER_RUNPUBLISH_PORTS),--publish $(P))
__DKR_PUBLISH_ALL= $(if $(filter true,$(DKR_CONTAINER_RUNPUBLISHEXPOSEDPORTS_FLAG)),--publish-all)
...
__DKR_RM= $(if $(filter true, $(DKR_CONTAINER_RUNAUTOREMOVAL_FLAG)),--rm)
...
__DKR_TAIL= $(if $(DKR_CONTAINER_TAILHISTORY_COUNT),--tail $(DKR_CONTAINER_TAILHISTORY_COUNT))
__DKR_TIMESTAMP= $(if $(filter true, $(DKR_CONTAINER_TAILTIMESTAMPS_FLAG)),--timestamps)
__DKR_TIME= $(if $(DKR_CONTAINER_STOP_TIME),--time $(DKR_CONTAINER_STOP_TIME))
__DKR_TTY= $(if $(filter true, $(DKR_CONTAINER_RUNTTY_FLAG)),--tty)
...
_dkr_list_parameters ::
	...
	@echo '    DKR_CONTAINER_DELETEFORCE_FLAG=$(DKR_CONTAINER_DELETEFORCE_FLAG)'
	...
	@echo '    DKR_CONTAINER_REMOVEVOLUMES_FLAG=$(DKR_CONTAINER_REMOVEVOLUMES_FLAG)'
	...
	@echo '    DKR_CONTAINER_RUNATTACH_STREAMS=$(DKR_CONTAINER_RUNATTACH_STREAMS)'
	@echo '    DKR_CONTAINER_RUNAUTOREMOVAL_FLAG=$(DKR_CONTAINER_RUNAUTOREMOVAL_FLAG)'
	@echo '    DKR_CONTAINER_RUNDETACH_FLAG=$(DKR_CONTAINER_RUNDETACH_FLAG)'
	@echo '    DKR_CONTAINER_RUNENVIRONMENT_KEYVALUES=$(DKR_CONTAINER_RUNENVIRONMENT_KEYVALUES)'
	@echo '    DKR_CONTAINER_RUNINTERACTIVE_FLAG=$(DKR_CONTAINER_RUNINTERACTIVE_FLAG)'
	@echo '    DKR_CONTAINER_RUNPUBLISH_PORTS=$(DKR_CONTAINER_RUNPUBLISH_PORTS)'
	@echo '    DKR_CONTAINER_RUNPUBLISHEXPOSEDPORTS_FLAG=$(DKR_CONTAINER_RUNPUBLISHEXPOSEDPORTS_FLAG)'
	@echo '    DKR_CONTAINER_RUNTTY_FLAG=$(DKR_CONTAINER_RUNTTY_FLAG)'
	...
	@echo '    DKR_CONTAINER_TAILDETAILS_FLAG=$(DKR_CONTAINER_TAILDETAILS_FLAG)'
	@echo '    DKR_CONTAINER_TAILFOLLOW_FLAG=$(DKR_CONTAINER_TAILFOLLOW_FLAG)'
