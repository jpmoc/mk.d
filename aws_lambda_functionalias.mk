...
_lba_view_framework_targets ::
	...
	@echo '    _lba_show_functionalias                       - Show everything related to the function-alias'
	@echo '    _lba_show_functionalias_description           - Show description of the function-alias'
	@echo '    _lba_view_functionaliases                     - View function-aliases'
	@echo '    _lba_view_functionaliases_set                 - View a set of function-aliases'
	@echo
...
_lba_create_functionalias:
	@$(INFO) '$(AWS_UI_LABEL)Creating functionalias "$(LBA_FUNCTIONALIAS_NAME)" to version "$(LBA_FUNCTION_VERSION)" of lambda-function "$(LBA_FUNCTION_NAME)" ...'; $(NORMAL)
...
_lba_delete_functionalias:
	@$(INFO) '$(AWS_UI_LABEL)Deleting alias "$(LBA_FUNCTIONALIAS_NAME)" of lambda-function "$(LBA_FUNCTION_NAME)" ...'; $(NORMAL)
	$(AWS) lambda delete-alias $(__LBA_FUNCTION_NAME) $(__LBA_NAME__FUNCTIONALIAS)

_lba_show_functionalias:
	@$(INFO) '$(AWS_UI_LABEL)Showing alias "$(LBA_FUNCTIONALIAS_NAME)" of lambda-function "$(LBA_FUNCTION_NAME)" ...'; $(NORMAL)
...
_lba_view_functionaliases:
	@$(INFO) '$(AWS_UI_LABEL)Viewing aliases of lambda-function "$(LBA_FUNCTION_NAME)" ...'; $(NORMAL)
	$(AWS) lambda list-aliases $(__LBA_FUNCTION_NAME__FUNCTIONALIAS) $(_X__LBA_FUNCTION_VERSION__FUNCTIONALIAS)

_lba_view_functionaliases_set:
	@$(INFO) '$(AWS_UI_LABEL)Viewing function-aliases-set "$(LBA_FUNCTIONALIASES_SET_NAME" ...'; $(NORMAL)
